...
# MDSR baseline model
#python main.py --template MDSR --model MDSR --scale 2+3+4 --save MDSR_baseline --reset --save_models --ext sep

# MDSR in the paper
#python main.py --template MDSR --model MDSR --scale 2+3+4 --n_resblocks 80 --save MDSR --reset --save_models --ext sep 

python main.py --template MDSR --model MDSR --scale 2+3+4 --n_resblocks 80 --reset --ext sep
